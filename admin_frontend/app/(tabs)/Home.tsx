...
import { View, Text, Image, Button, ScrollView, StyleSheet, TouchableOpacity, StatusBar } from 'react-native';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.welcomeBanner}>
        <Image source={{ uri: 'https://picsum.photos/150' }} style={styles.profilePic} />
        <Text style={styles.welcomeText}>Welcome back, {userData.admin_fname}</Text>
      </View>

      {/* Quick Actions */}
      {/* <View style={styles.quickActions}>
        <Button title="Make a Donation" onPress={() => navigation.navigate('')} />
        <Button title="View Donation History" onPress={() => navigation.navigate('')} />
      </View> */}
